...
public:
    ...
    ~VideoCapturePlusQt(void);
    VideoCapturePlusQt(const char* _fileName, const char* _defaultFileName="", int _firstFrame=0, int _verbose=0, int camNo=0);
    bool Start_Read(const char* _fileName, const char* _defaultFileName="", int _firstFrame=0, int _verbocity=0, int camNo=0);
